...
class CrashRegistrationForm(http.Controller):
    @http.route(['/crash_form/registration/<string:batch_id>'], type='http', auth="public", website=True)
    ...
    @http.route(['/crash_form/registration/submit'], type='http', auth="public", website=True, csrf=False, method=['POST'])
